      ...
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="px-6 pb-6 -mt-10">
            <div className="flex items-end justify-between">
              <div className="relative">
                {user?.image ? (
                  ...
                  <div
                    className="w-20 h-20 rounded-2xl border-4 border-white shadow-md flex items-center justify-center text-white font-black text-2xl"
                    style={{
                      background: `linear-gradient(135deg, ${RED} 0%, ${RED_DARK} 100%)`,
                    }}
                  >
                ...
                <div
                  className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-white ${isBlocked ? "bg-red-400" : "bg-emerald-400"}`}
                />
              </div>
              {!isBlocked && (
                <button
            ...
            <div className="mt-4">
              <h1 className="text-[22px] font-black text-gray-800">
                {user?.name}
              </h1>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                >
                  ...
                  {(LOCATIONS[formData.district] || []).map((u) => (
