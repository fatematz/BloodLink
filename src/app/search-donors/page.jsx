...
export default function SearchDonorsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F9]">
      ...
      {/* Hero */}
      <div
        className="pt-36 pb-16 px-4 text-center"
        style={{
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {donors.map((donor) => (
                ...
                >
                  {/* Card Top */}
                  <div
                    className="relative pt-6 pb-8 flex flex-col items-center"
                    style={{
                  ...
                  >
                    ...
                    {/* Blood Group Badge */}
                    <div
                      className="absolute top-3 right-3 w-9 h-9 rounded-full flex items-center justify-center text-white text-[11px] font-black"
                      style={{
                        background: `linear-gradient(135deg, ${RED} 0%, ${RED_DARK} 100%)`,
                      }}
                    >
                  ...
                  <div className="px-4 pb-4 pt-1">
                    <p className="font-bold text-gray-800 text-center text-[16px]">
                      {donor.name}
                    </p>
